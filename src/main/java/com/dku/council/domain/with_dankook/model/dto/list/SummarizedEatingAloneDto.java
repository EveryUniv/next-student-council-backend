...
public class SummarizedEatingAloneDto extends SummarizedWithDankookDto {
    ...
    public SummarizedEatingAloneDto(SummarizedWithDankookDto dto, EatingAlone eatingAlone, int recruitedCount, MessageSource messageSource) {
        super(dto);
        this.title = eatingAlone.getTitle();
        this.body = eatingAlone.getContent();
        this.status = messageSource.getMessage("withdankook." + eatingAlone.getStatus().toLowerCase(), new Object[]{}, LocaleContextHolder.getLocale());
